...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.btn_open_dailog = tk.Button(toolbar, bg='#d7d8e0', bd=0, image=self.add_img, command=self.open_dailog)
        self.btn_open_dailog.pack(side=tk.LEFT)
